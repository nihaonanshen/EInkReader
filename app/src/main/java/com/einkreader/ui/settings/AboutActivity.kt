...
class AboutActivity : Activity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        addText(root, "版本 0.0.1", 16f, false, 0, 4)
        addText(root, "", 16f, false, 0, 6)
        addText(root, "项目说明", 18f, true, 0, 4)
        addText(root, "\u2022 作者零基础起步，全程 AI 辅助开发", 15f, false, -0x99999a.toInt(), 2)
        addText(root, "\u2022 AI Agent: Reasonix", 15f, false, -0x99999a.toInt(), 2)
        addText(root, "\u2022 AI 模型: DeepSeek V4", 15f, false, -0x99999a.toInt(), 2)
        addText(root, "\u2022 开发环境: Android Studio + Gradle", 15f, false, -0x99999a.toInt(), 10)
        ...
        addText(root, "\u2022 自动检测文本编码（GBK/UTF-8/Big5）", 15f, false, 0, 2)
        addText(root, "\u2022 智能提取中英文书籍目录", 15f, false, 0, 2)
        addText(root, "\u2022 EPUB 图片显示", 15f, false, 0, 2)
        addText(root, "\u2022 可调节字体大小 / 行距 / 段距 / 边距", 15f, false, 0, 2)
        addText(root, "\u2022 支持更换字体（TTF/OTF）", 15f, false, 0, 2)
        addText(root, "\u2022 墨水屏刷新优化（局部/全局刷新）", 15f, false, 0, 2)
        addText(root, "\u2022 夜间模式切换", 15f, false, 0, 2)
        addText(root, "\u2022 书架排序（时间/名称/格式）", 15f, false, 0, 2)
        addText(root, "\u2022 阅读进度自动保存与恢复", 15f, false, 0, 2)
        addText(root, "\u2022 阅读统计（累计阅读时长）", 15f, false, 0, 10)
        ...
        addText(root, "\u2022 将 TXT/EPUB 文件放到 SD 卡上即可自动识别", 14f, false, -0x99999a.toInt(), 2)
        addText(root, "\u2022 将 TTF 字体文件放到 /sdcard/fonts/ 可在设置中选用", 14f, false, -0x99999a.toInt(), 2)
        addText(root, "\u2022 长按书籍可删除", 14f, false, -0x99999a.toInt(), 2)
